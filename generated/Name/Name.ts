...
export class Name extends ethereum.SmartContract {
  static bind(address: Address): Name {
    return new Name("Name", address);
  }
  ...
  getName(_tokenId: BigInt): string {
  ...
  try_getName(_tokenId: BigInt): ethereum.CallResult<string> {
  ...
  mint(_to: Address, _name: string): BigInt {
  ...
  try_mint(_to: Address, _name: string): ethereum.CallResult<BigInt> {
